...
public class TestaMusica {
	...
	public static void main(String[] args) {
		...
		programando.adicionar(programandoMusica1);
		programando.adicionar(programandoMusica2);
		...
		descansando.adicionar(descansandoMusica1);
		descansando.adicionar(descansandoMusica2);
		descansando.adicionar(descansandoMusica3);
		...
		estudando.adicionar(concentracao);
